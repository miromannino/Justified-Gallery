...
(function($) {
   ...
   */
  JustifiedGallery.prototype.newSrc = function (imageSrc, imgWidth, imgHeight, imgSizes) {
    var newImageSrc;
    
    if (this.settings.thumbnailPath) {
      newImageSrc = this.settings.thumbnailPath(imageSrc, imgWidth, imgHeight, imgSizes);
    } else {
