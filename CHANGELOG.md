...
- Playwright E2E tests with visual layout inspection
- Vitest unit tests
...
- The default suffixes are all empty, to be simpler to understand.
- Now is possible to have entries with a caption `div`.
- Fixed margins
